...
-   `A[i][j]`：存储在第 $ \lfloor(i \times 4 + \lfloor j/8) \rfloor)/32\rfloor $ 个块，存储着 `A[i][ ⌊j/8⌋ ]` ~ `A[i][ ⌊j/8⌋+7 ]`
-   `B[j][i]`：存储在第 $ \lfloor(j \times 4 + \lfloor i/8) \rfloor)/32\rfloor $ 个块，存储着 `B[j][ ⌊i/8⌋ ]` ~ `B[j][ ⌊i/8⌋+7 ]`
